...
export const warehouses = [
  {
    ...
    imageAlt:
      'Two-level frontage of the HRBR Layout facility at dusk, with roller shutters, an external spiral stair and the wall lights on',
    gallery: [
      {
        src: frontageDusk,
        alt: 'Two-level frontage with roller shutters and an external spiral stair, photographed in the evening',
      },
      {
