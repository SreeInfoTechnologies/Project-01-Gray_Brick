...
export function TrustBand() {
  return (
    <section aria-labelledby="trust-heading" className="border-b border-gb-line-light bg-gb-white py-12 sm:py-14">
      <Container>
        <div className="flex flex-col gap-7 lg:flex-row lg:items-center lg:gap-14">
          <div className="lg:max-w-sm lg:shrink-0">
            ...
            <Reveal delay={1}>
              <h2 id="trust-heading" className="mt-4 text-xl leading-snug font-bold tracking-tight text-gb-graphite sm:text-2xl">
              ...
              {industries.map((industry) => (
                <Reveal as="li" key={industry.id} variant="fade">
                  <Link
                    ...
                    className="block border border-gb-line-light bg-gb-pure px-3.5 py-2 text-[0.8125rem] font-medium text-gb-industrial transition-[border-color,color,transform] duration-300 ease-[var(--ease-gb)] hover:-translate-y-0.5 hover:border-gb-gold hover:text-gb-graphite"
                  >
                    {industry.title}
                  </Link>
                </Reveal>
